...
#tombol
btn1 = Button(root, text="Rp. 500", width=20, bg="darkgrey", command=lambda: klik(500))
btn1.grid(row=14, column=2)
btn2 = Button(root, text="Rp. 1000", width=20, bg="darkgrey", command=lambda: klik(1000))
btn2.grid(row=14, column=3)
btn3 = Button(root, text="Rp. 2000", width=20, bg="darkgrey", command=lambda: klik(2000))
btn3.grid(row=14, column=4)
btn4 = Button(root, text="Rp. 5000", width=20, bg="darkgrey", command=lambda: klik(5000))
btn4.grid(row=15, column=2)
btn5 = Button(root, text="TAMBAH", width=20, bg="darkgrey", command=nambah)
btn5.grid(row=12, column=2)
btn6 = Button(root, text="CEK TOTAL", width=20, command=total_harga, bg="darkgrey")
btn6.grid(row=12, column=3)
btn7 = Button(root, text="CEK KEMBALIAN", width=20, command=mulang, bg="darkgrey")
btn7.grid(row=12, column=4)
btn8 = Button(root, text="Rp. 10000", width=20, bg="darkgrey", command=lambda: klik(10000))
btn8.grid(row=15, column=3)
btn9 = Button(root, text="Rp. 20000", width=20, bg="darkgrey", command=lambda: klik(20000))
btn9.grid(row=15, column=4)
btn10 = Button(root, text="Rp. 50000", width=20, bg="darkgrey", command=lambda: klik(50000))
btn10.grid(row=16, column=2)
btn11 = Button(root, text="Rp. 100000", width=20, bg="darkgrey", command=lambda: klik(100000))
btn11.grid(row=16, column=3)
btn12 = Button(root, text="=", width=20, bg="darkgrey", command=samdeng)
btn12.grid(row=16, column=4)
btn13 = Button(root, text="+", width=20, bg="darkgrey", command=tambah)
btn13.grid(row=13, column=4)
btn14 = Button(root, text="SELESAI", width=42, command=selesai, bg="darkgrey")
btn14.grid(row=17, column=2, columnspan=3)
